...
def set_plot(width, height, data):
    global PLOTS
    PLOTS.clear()
    PLOTS = [
            { 
...
class FigureManagerLungan(FigureManagerBase):
...
class FigureCanvasLungan(FigureCanvasAgg):
    manager_class = FigureManagerLungan


@_Backend.export
class _BackendLunganAgg(_Backend):

    FigureCanvas = FigureCanvasLungan
    FigureManager = FigureManagerLungan
